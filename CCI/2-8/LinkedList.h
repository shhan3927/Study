...
Node<int>* InsertHeadInLinkedList(Node<int>** head, Node<int>* node)
{
    *head = node;
    return node;
}

Node<int>* InsertTailInLinkedList(Node<int>** head, Node<int>* node)
{
    if(*head == nullptr)
    {
        *head = node;
...
Node<int>* InsertTailInLinkedList(Node<int>** head, int data)
{
    ...
    return InsertTailInLinkedList(head, node);
}
